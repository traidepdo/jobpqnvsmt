...
export default function TemplateForm({ mode, initialData }: TemplateFormProps) {
    ...
    return (
        <div className="min-h-screen bg-black-500">
            {/* Top bar */}
            <header className="bg-black border-b border-gray-100 flex items-center justify-between px-6 h-14 sticky top-0 z-10">
            ...
            {/* Body */}
            <div className="flex gap-0 h-[calc(100vh-56px)] bg-black-500">
                {/* Left: meta fields */}
                <aside className="w-[300px] flex-shrink-0 bg-black border-r border-gray-100 overflow-y-auto p-5 flex flex-col gap-4">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    {/* Tab bar */}
                    <div className="bg-black border-b border-gray-100 flex items-center px-4 gap-0">
...
function inputCls(hasError: boolean) {
    return `w-full h-9 text-[13px] bg-black-500 border rounded-lg px-3 outline-none transition-all
    ${hasError
