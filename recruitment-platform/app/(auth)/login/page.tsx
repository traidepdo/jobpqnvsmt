...
function LoginPageContent() {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            } else if (registered === 'employer') {
                setSuccess('Đăng ký thành công! Vui lòng chờ phê duyệt.');
            }
                    ...
                    <div className="w-full max-w-[420px] bg-black/45 border border-white/10 backdrop-blur-2xl p-6 md:p-8 rounded-3xl shadow-2xl shadow-black/40 anim-fade-up flex flex-col justify-between my-auto">
                        <div>
                            ...
                            <form onSubmit={handleLogin} className="space-y-4">
                                ...
                                {/* Divider */}
                                <div className="relative my-4 flex items-center anim-fade-up d5">
                                    <div className="flex-grow border-t border-white/10"></div>
                                    <span className="flex-shrink mx-4 text-[10px] font-bold text-slate-400 uppercase tracking-wider">Hoặc</span>
                                    <div className="flex-grow border-t border-white/10"></div>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full py-3 rounded-xl font-bold text-white text-xs cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 bg-white/[0.06] border border-white/10 hover:bg-white/[0.12] hover:border-white/20 active:scale-[0.99] flex items-center justify-center gap-2.5 shadow-lg anim-fade-up d5"
                                >
...
export default function LoginPage() {
    return (
        <Suspense fallback={
            <div className="h-screen w-screen bg-[#021f18] flex items-center justify-center text-white font-sans">
