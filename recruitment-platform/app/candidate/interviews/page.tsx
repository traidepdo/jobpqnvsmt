    ...
    return (
        <div className="min-h-screen bg-[#f4f5f5]">
            ...
            <div className="bg-white border-b border-gray-100">
                <div className="max-w-[1000px] mx-auto px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
                    <a href="/" className="hover:text-[#00b14f] transition-colors">Trang chủ</a>
                    <span className="material-symbols-outlined text-[14px]">chevron_right</span>
                    <span className="text-[#041b3c] font-medium">Lịch phỏng vấn</span>
                </div>
            </div>
